...
//create stairs
const staircase1 = createStaircaseWithCollision({color: '#FFFFF'});
const staircase2 = createStaircaseWithCollision({color: '#FFFFF'});
const staircase3 = createStaircaseWithCollision({color: '#FFFFF'});
const staircase4 = createStaircaseWithCollision({color: '#FFFFF'});

//add staircases to the areas
area1.add(staircase1);
staircase1.position.set(0,-3.5,60);
staircase1.rotation.y = Math.PI;
area2.add(staircase2);
staircase2.position.set(0,-3.5,60);
staircase2.rotation.y = Math.PI;
area3.add(staircase3);
staircase3.position.set(0,-3.5,60);
staircase3.rotation.y = Math.PI;
